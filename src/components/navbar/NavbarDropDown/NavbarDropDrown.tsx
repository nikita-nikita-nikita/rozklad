        ...
        <div id='header__navbar-dropdown'
            ...
            <div className='header__navbar-dropdown__container'>
                <div className='header__navbar-body' onClick={() => {
                    ...
                    <img className='header__navbar-dropdown-img' src={profile} alt='profile'/>
                ...
                <div className='header__navbar-buttons'>
                    <button>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            ...
                            <path
                                ...
                                stroke="#5E89FE"/>
                            <path
                                d="M4.50642 11.426C5.68101 10.7841 6.99217 10.2483 8.21725 9.70987C10.3249 8.82789 12.4408 7.96121 14.5782 7.15433C14.994 7.01686 15.7412 6.88243 15.8145 7.49381C15.7744 8.35925 15.6093 9.21963 15.4961 10.08C15.2088 11.972 14.8767 13.8576 14.5529 15.7434C14.4413 16.3716 13.6482 16.6967 13.1407 16.2948C11.921 15.4774 10.692 14.668 9.48795 13.8318C9.09353 13.4342 9.45928 12.8631 9.81153 12.5792C10.8161 11.597 11.8814 10.7626 12.8334 9.72968C13.0902 9.11444 12.3314 9.63294 12.0812 9.79183C10.7059 10.732 9.36439 11.7296 7.91449 12.556C7.17388 12.9604 6.31069 12.6148 5.57042 12.3891C4.90668 12.1164 3.93404 11.8417 4.50635 11.426L4.50642 11.426Z"
                                fill="#5E89FE"/>
                        </svg>
                    ...
                    <button>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                ...
                                stroke="#F13C20" stroke-linecap="round"/>
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div className='logout' onClick={logOut}>
                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                  d="M17.5003 4.66669V23.3334H4.66699L4.66699 4.66669L17.5003 4.66669Z"
                                  stroke="#5E89FE" stroke-linecap="round" stroke-linejoin="round"/>
